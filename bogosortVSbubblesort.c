...
void randomizeArray(int array[], int top){//Randomizes array after fillArray function is called. Also is the same randomiser used in the bogosort algorithm. May not be totally random because bogosort orders the array much faster than it should.
	srand(time(NULL));
